        ...
        <div class="col-sm-12">
            <div class="page-title-box d-md-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center gap-2">
                    <h4 class="page-title mb-0 me-3">Educational Experience</h4>

                    <a href="{{route('create-education')}}" class="btn btn-primary">
                ...
                <div>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active">Educational Experience</li>
                    </ol>
                </div>
            </div>
